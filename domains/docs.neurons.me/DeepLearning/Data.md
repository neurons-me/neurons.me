...
Each feature 𝑥𝑖 has an associated weight 𝑤𝑖. The weight indicates the importance or contribution of that feature to the final prediction.
Positive weights increase the likelihood of the positive class (e.g., "cat"), while negative weights decrease it.
Bias (𝑏
b):The bias term helps shift the decision boundary. It acts as a threshold to help the model fit the data better.